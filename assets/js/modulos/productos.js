...
document.addEventListener("DOMContentLoaded", function () {
    ...
    formulario.addEventListener("submit", function (e) {
        ...
        errorCompra.textContent = "EL PRECIO COMPRA ES OBLIGATORIO...";
        } else if (precio_venta.value == "") {
        errorVenta.textContent = "EL PRECIO VENTA ES OBLIGATORIO...";
    ...
    http.onreadystatechange = function () {
        ...
        containerPreview.innerHTML = `<img class="img-thumbnail" src="${base_url + res.foto}" alt="" width="200"><button class="btn btn-danger" type="button" onclick="deleteImg()"><i class="fas fa-trash"></i> </button>`;
