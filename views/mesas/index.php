                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <select id="tiempo" class="form-control" name="tiempo" onchange="selectNit(event)">
                                    ...
                                    <option data-nit="9.00" value="1 HORA Y MEDIA">1 HORA Y MEDIA</option>
                                    <option data-nit="12.00" value="2 HORAS">2 HORAS</option>
                                    <option data-nit="15.00" value="2 HORAS Y MEDIA">2 HORAS Y MEDIA</option>
                                    <option data-nit="18.00" value="3 HORAS">3 HORAS</option>
                                    <option data-nit="21.00" value="3 HORAS Y MEDIA">3 HORAS Y MEDIA</option>
                                    <option data-nit="24.00" value="4 HORAS">4 HORAS</option>
                                    <option data-nit="27.00" value="4 HORAS Y MEDIA">4 HORAS Y MEDIA</option>
                                    <option data-nit="30.00" value="5 HORAS">5 HORAS</option>
                                    <option data-nit="33.00" value="5 HORAS Y MEDIA">5 HORAS Y MEDIA</option>
                                    <option data-nit="36.00" value="6 HORAS">6 HORAS</option>
                                    <option data-nit="39.00" value="6 HORAS Y MEDIA">6 HORAS Y MEDIA</option>
                                    <option data-nit="42.00" value="7 HORAS">7 HORAS</option>
                                    <option data-nit="45.00" value="7 HORAS Y MEDIA">7 HORAS Y MEDIA</option>
                                    <option data-nit="48.00" value="8 HORAS">8 HORAS</option>
                                    <option data-nit="51.00" value="8 HORAS Y MEDIA">8 HORAS Y MEDIA</option>
                                    <option data-nit="54.00" value="MESA TRES">9 HORAS</option>
                                    <option data-nit="57.00" value="MESA TRES">9 HORAS Y MEDIA</option>
                                    <option data-nit="60.00" value="MESA TRES">10 HORAS</option>
                                </select>
                            </div>
                            <span class="text-danger fw-bold mb-2" id="errorTiempo"></span>
